...
class MainViewController: UIViewController {
    ...
    private var sideMenuRevealWidth: CGFloat = 310
    ...
    // Сохраняйте состояние бокового меню (развернутое или свернутое) в ротации
...
//            self.showViewController(viewController: BooksViewController.self, storyboardId: "BooksVCID")
        ...
        // Свернуть боковое меню с анимацией
        DispatchQueue.main.async { self.sideMenuState(expanded: false) }
    }

    func showViewController<T: UIViewController>(viewController: T.Type, storyboardId: String) -> () {
        
        // Удалить предыдущий вид
...
extension MainViewController: UIGestureRecognizerDelegate {
    ...
    // Закройте боковое меню при нажатии на вид теневого фона
    ...
    @objc private func handlePanGesture(sender: UIPanGestureRecognizer) {
        ...
        case .began:
            ...
            // Если пользователь пытается расширить меню больше, чем ширина раскрытия, отмените жест панорамирования.
...
extension UIViewController {
    ...
    // С помощью этого расширения вы можете получить доступ к MainViewController из дочерних контроллеров представления.
